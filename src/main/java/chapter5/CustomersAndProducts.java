...
public class CustomersAndProducts {
    ...
    public static void main(String[] args) {
        ...
        String customer_file = "src/main/resources/chapter5/customers.csv";
        ...
        String products_file = "src/main/resources/chapter5/products.csv";
        ...
        String purchases_file = "src/main/resources/chapter5/purchases.csv";
